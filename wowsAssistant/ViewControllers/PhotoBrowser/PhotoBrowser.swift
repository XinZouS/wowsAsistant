...
open class PhotoBrowser: UIViewController {
    ...
    /// CollectionView 数据源
    open var dataSource: PhotoBrowserDataSource
    
    /// CollectionView 代理
    open var delegate: PhotoBrowserDelegate
    
    /// 转场动画代理
    open var transDelegate: PhotoBrowserTransitioningDelegate {
        didSet {
    ...
    public init(dataSource: PhotoBrowserDataSource,
                delegate: PhotoBrowserDelegate = PhotoBrowserBaseDelegate(),
                transDelegate: PhotoBrowserTransitioningDelegate = PhotoBrowserFadeTransitioning()) {
    ...
    /// 打开浏览器
    open func show(currentTopVC: UIViewController, pageIndex: Int) {
        self.pageIndex = pageIndex
        //UIViewController.jx.topMost?.present(self, animated: true, completion: nil)
        currentTopVC.present(self, animated: true, completion: nil)
    }
